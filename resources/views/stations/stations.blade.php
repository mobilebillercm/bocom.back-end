                            ...
                            <div class="well">
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1">
                                        <form action="{{url('nouvelle-station')}}" method="get" class="pull-right">
                                            <button class="login100-form-btn-blue pull-right" type="submit" style="margin-top: -10px;">
                                                <i class="fa fa-plus"></i> &nbsp;&nbsp;Nouvelle Station
                                            </button>
                                        </form>
                                        <br><br>
                                        <ul class="list-group menu-transaction" style="width: 100%;">
                                            @foreach($stations as $station)
                                                <li class="list-group-item row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <a class="menu-link-color pull-right" href="{{url('/stations/' . $station->stationid)}}">
                                                            Plus de Details
                                                        </a>
                                                    </div>
                                                </li>
