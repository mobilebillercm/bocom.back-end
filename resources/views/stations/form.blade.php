                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/nouvelle-station')}}" id="form-topup"
                                                  enctype="multipart/form-data">
                                                <span class="login100-form-logo">
						                            <i class="fa fa-plus"></i>
					                            </span>
                                                <span class="login100-form-title p-b-34 p-t-27" style="color: #0F8334;">
                                                    Ajouter nouvelle Station
                                                </span>
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="bp" style="font-size: 16px;">Boitee Postal<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="bp" id="bp"
                                                                   placeholder="Boite Postale de la Station"
                                                                   style="color: #0d0d0d;" /> <br>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="region" style="font-size: 16px;">Region<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="region" id="region"
                                                                   placeholder="Region de la Station"
                                                                   style="color: #0d0d0d;" /> <br>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="division" style="font-size: 16px;">Departement<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="division" id="division"
                                                                   placeholder="Departement de la Station"
                                                                   style="color: #0d0d0d;" /> <br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="subdivision" style="font-size: 16px;">Arrondissement<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="subdivision" id="subdivision"
                                                                   placeholder="Arrondissement de la Station"
                                                                   style="color: #0d0d0d;" /> <br>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="quarter" style="font-size: 16px;">Quartier<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="quarter" id="quarter"
