                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/stations/'.$station->stationid.'/add-image')}}" id="form-topup"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="logo" style="font-size: 16px;">Image<b style="color: red;" class=""> *</b></label>
