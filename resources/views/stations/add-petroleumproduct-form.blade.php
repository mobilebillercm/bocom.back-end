                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/stations/'.$station->stationid.'/add-petroleumproducts')}}" id="form-topup"
                                                  enctype="multipart/form-data">
                                                <span class="login100-form-logo">
						                            <i class="fa fa-plus"></i>
					                            </span>
                                                <span class="login100-form-title p-b-34 p-t-27" style="color: #0F8334;">
                                                    Ajouter un Produit Petrolier
                                                </span>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div cclass="form-group" style="text-align: left;">
                                                                <label for="petroleumproductid" style="font-size: 16px;">Produit Petrolier<b style="color: red;" class=""> *</b></label>
                                                                <select class="form-control form-control-text" required name="petroleumproductid" id="petroleumproductid"
                                                                        style="color: #0d0d0d;" >
                                                                    <option value="">--- Choisir un Produit Petrolier ---</option>
                                                                @foreach($petroleumproducts as $petroleumproduct)
                                                                        <option value="{{$petroleumproduct->petroleumproductid}}">{{$petroleumproduct->name}}</option>
                                                                    @endforeach
                                                                </select> <br>
                                                            </div>
                                                        </div>
