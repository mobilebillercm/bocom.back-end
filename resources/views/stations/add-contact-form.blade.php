                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/stations/'.$station->stationid.'/add-contacts')}}" id="form-topup"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="tel" style="font-size: 16px;">Telephone<b style="color: red;" class=""> *</b></label>
                                                            <input type="tel" class="form-control form-control-text" required name="tel" id="tel"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="bp" style="font-size: 16px;">Boite Postale<b style="color: red;" class=""> *</b></label>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="address" style="font-size: 16px;">Adresse<b style="color: red;" class=""> *</b></label>
                                                            <input type="text" class="form-control form-control-text" required name="address" id="address"
                                                                   placeholder="Adresse"
                                                                   style="color: #0d0d0d;" /> <br>
                                                        </div>
                                                    </div>
