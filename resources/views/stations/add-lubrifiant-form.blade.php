                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/stations/'.$station->stationid.'/add-lubrifiants')}}" id="form-topup"
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div cclass="form-group" style="text-align: left;">
                                                                <label for="lubrifiantid" style="font-size: 16px;">Produit Lubrifiant<b style="color: red;" class=""> *</b></label>
                                                                <select class="form-control form-control-text" required name="lubrifiantid" id="lubrifiantid"
                                                                        style="color: #0d0d0d;" >
                                                                    <option value="">--- Choisir un Produit Lubrifiant ---</option>
                                                                    @foreach($lubrifiants as $lubrifiant)
                                                                        <option value="{{$lubrifiant->lubrifiantid}}">{{$lubrifiant->name}}</option>
                                                                    @endforeach
                                                                </select> <br>
                                                            </div>
                                                        </div>
