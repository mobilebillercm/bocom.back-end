@extends('layouts.app')
@section('title', 'BOCOM Petroleum sa/Services')
                            ...
                            <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
                                <div class="btn-group" role="group">
                                    <button type="button" id="stars" class="btn btn-info btn-lg" href="#tab1" data-toggle="tab">
                                        <div class="hidden-xs" style="font-size: x-large;">SERVICES <span class="glyphicon glyphicon-star" aria-hidden="true"></span></div>
                                    </button>
                                </div>
                                {{--<div class="btn-group" role="group">
                            ...
                            <div class="well">
                                <div class="tab-content">
                                    <div class="tab-pane fade in active" id="tab1">
                                        <form action="{{url('nouveau-service')}}" method="get" class="pull-right">
                                        ...
                                        <ul class="list-group menu-transaction" style="width: 100%;">
                                            @foreach($services as $service)
                                                <li class="list-group-item row">
                                                    <div class="col-md-2">
                                                        <img src="{{url('/service/'. $service->serviceid.'/logo')}}"/>
                                                    </div>
                                                    <div class="col-md-10">
                                                        <h3>{{$service->name}}</h3>
