@extends('layouts.app')
@section('title', 'BOCOM Petroleum sa/Product Form')
                                ...
                                <div class="">
                                    <div class="" style="color: #0F8334; border-radius: 8px;">
                                        <div class="" style="width: 100%; padding: 15px; border-radius: 8px;">
                                            <form class="form-style-9" method="post" action="{{url('/nouveau-produit-petrolier')}}" id="form-topup"
                                            enctype="multipart/form-data">
                                                <span class="login100-form-logo">
						                            <i class="fa fa-plus"></i>
					                            </span>
                                                <span class="login100-form-title p-b-34 p-t-27" style="color: #0F8334;">
                                                        Ajouter nouveau Produit Petrolier
                                                    </span>
                                                @csrf
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div cclass="form-group" style="text-align: left;">
                                                            <label for="price" style="font-size: 16px;">Prix<b style="color: red;" class=""> *</b></label>
                                                            <input type="number" class="form-control form-control-text" required name="price" id="price"
